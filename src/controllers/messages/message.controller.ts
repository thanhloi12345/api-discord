...
export const getMessages = async (req: RequestWithAuth, res: Response) => {
  try {
...
export const createMessage = async (req: RequestWithAuth, res: Response) => {
  if (req.method !== "POST") {
...
export const deleteOrUpdateMessage = async (
  req: RequestWithAuth,
  res: Response
) => {
